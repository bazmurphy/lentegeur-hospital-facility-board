...
import { Service, ServiceImage } from "../ServicesPage/ServicesPage";
import { NewsArticle, NewsArticleImage } from "../NewsPage/NewsPage";
import { Event, EventImage } from "../EventsPage/EventsPage";

export type ContentImage = ServiceImage & NewsArticleImage & EventImage;
export type Content = Service & NewsArticle & Event;
...
const ContentPage = () => {
  ...
  const contentData: Content = data?.data[0];
