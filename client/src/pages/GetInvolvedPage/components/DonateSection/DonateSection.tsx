...
export interface DonateSectionProps {
  donateSectionText: GetInvolved["donateSectionText"];
  bankAccountName: GetInvolved["bankAccountName"];
  bankName: GetInvolved["bankName"];
  bankAccountNumber: GetInvolved["bankAccountNumber"];
  bankBranchCode: GetInvolved["bankBranchCode"];
  bankSwiftCode: GetInvolved["bankSwiftCode"];
}
